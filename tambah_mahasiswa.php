...
$pesan = "Mahasiswa dengan nama = \"<b>$nama</b>\" sudah berhasil ditambah";
                            ...
                            <select name="bln">
                                ...
                                <p>
                                    ...
                                    <p>
                                        ...
                                        <input type="text" name="ipk" id="ipk" value="<?php echo $ipk ?>"placeholder="Contoh: 2.75">(angka desimal dipisah dengan karakter titik ".")
                                    </p>
                                </fieldset>
                                <br>
                                <p>
